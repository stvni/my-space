  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="relative hidden md:flex flex-col h-full bg-surface border-r border-border overflow-hidden shrink-0"
      >
        {/* Logo */}
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              clsx(
                ...
                isActive ? 'text-chrome-bright' : 'text-chrome-dim'
              )
            }
            aria-label={label}
          >
